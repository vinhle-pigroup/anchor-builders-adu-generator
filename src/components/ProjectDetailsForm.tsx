...
import { Building2, Palette, Wrench, Plus, Clock, FileText, ArrowLeft, Calculator } from 'lucide-react';
            ...
            <div className='lg:col-span-2 space-y-4'>
              ...
              <div className='bg-white rounded-lg shadow-sm border-l-4 border-blue-500'>
                <div className='bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-t-lg'>
                  <div className='flex items-center'>
                    <div className='w-7 h-7 bg-blue-500 text-white rounded-full flex items-center justify-center mr-3 text-sm font-bold'>1</div>
                      ...
                      {aduTypeOptions.map(option => (
                        ...
                        >
                          <div className='flex justify-between items-center'>
                            ...
                            <div className='text-blue-600 font-medium text-sm'>${option.pricePerSqFt}/sq ft</div>
                          </div>
                        </button>
                      ))}
                    </div>
              ...
              <div className='bg-white rounded-lg shadow-sm border-l-4 border-green-500'>
                <div className='bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-t-lg'>
                  <div className='flex items-center'>
                    <div className='w-7 h-7 bg-green-500 text-white rounded-full flex items-center justify-center mr-3 text-sm font-bold'>2</div>
                    ...
                    <div className='space-y-3'>
                      ...
                      <div className='space-y-2 text-sm'>
                        ...
                        <div className='flex justify-between'>
                          ...
                          <span className='font-medium'>${formData.selectedAddOns.reduce((sum, name) => {
                      ...
                      <div className='border-t pt-3 space-y-2'>
                        <div className='flex justify-between'>
                          ...
                          <span className='font-medium'>${currentPricing.totalBeforeMarkup.toLocaleString()}</span>
                        </div>
                        <div className='flex justify-between'>
                          <span className='text-slate-600'>Markup (15%)</span>
                          <span className='font-medium'>${currentPricing.markupAmount.toLocaleString()}</span>
                        </div>
                        <div className='flex justify-between font-semibold text-lg'>
                          <span className='text-slate-800'>Total</span>
                          <span className='text-anchor-600'>${currentPricing.grandTotal.toLocaleString()}</span>
                        </div>
                  ...
                  <div className='bg-white rounded-lg shadow-sm p-6'>
                    ...
                    <div className='mt-4 pt-3 border-t'>
                      <div className='flex justify-between font-semibold'>
                        ...
                        <span className='text-anchor-600'>${milestones.reduce((sum, m) => sum + m.amount, 0).toLocaleString()}</span>
                      </div>
                    </div>
